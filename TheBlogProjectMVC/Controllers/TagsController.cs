...
namespace TheBlogProjectMVC.Controllers
{
    public class TagsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PostId,BlogsUserId,Text")] Tag tag)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PostId,BlogsUserId,Text")] Tag tag)
        {
            if (id != tag.Id)
            {
                return NotFound();
